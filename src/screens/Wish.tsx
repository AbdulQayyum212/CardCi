  ...
  return (
    <SafeAreaView
      ...
      <View style={tw` items-center  w-full justify-center px-5 `}>
        ...
        <View>
          <View
            style={tw`p-[10] w-[100%] flex-row items-center justify-between gap-3`}>
            <View
              style={tw`w-35 h-20 shadow-2xl bg-white rounded-lg justify-between overflow-hidden`}>
              ...
              <LinearGradient
                ...
                style={[tw`w-35  h-8 justify-center items-center `]}>
